...
import com.example.demo.service.CertificateTypeService;
...
public class CertificateTypeController {
    ...
    @PostMapping("/add")
    public CertificateType add(@RequestBody CertificateType cert) {
    ...
    public CertificateType update(@PathVariable Long id, @RequestBody CertificateType updatedCert) {
        return service.updateCertificate(id, updatedCert);
    }
}
